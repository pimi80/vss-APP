...
import Animated, { FadeInRight, FadeIn, SlideInRight } from 'react-native-reanimated';
...
export default function RightDrawer({
  ...
  return (
    <View style={styles.overlay}>
      ...
      <Animated.View entering={SlideInRight.duration(300)} style={[styles.drawer, { backgroundColor: colors.surface }]}>
        ...
        <View style={[styles.footer, { borderTopColor: colors.border }]}>
          ...
          <Text style={[styles.footerText, { color: colors.textSecondary, writingDirection: 'ltr' }]}>vss Browser App v1.0</Text>
...
const styles = StyleSheet.create({
  overlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, zIndex: 9998, elevation: 9998 },
  backdrop: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.6)' },
  drawer: { position: 'absolute', top: 0, right: 0, bottom: 0, width: 300 },
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: 30, marginBottom: 20 },
