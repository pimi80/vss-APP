      ...
      <View style={styles.overlay}>
        ...
        <View style={[styles.drawer, { backgroundColor: colors.surface }]}>
          ...
          <View style={styles.section}>
            ...
            {tools.map((tool, i) => (
              <TouchableOpacity key={i} style={[styles.toolItem, { opacity: tool.disabled ? 0.3 : 1 }]} onPress={tool.action} disabled={tool.disabled}>
          ...
          <View style={[styles.footer, { borderTopColor: colors.border }]}>
            <Text style={[styles.footerText, { color: colors.textSecondary }]}>ابزارهای ناوبری VSS</Text>
          </View>
        </View>
      </View>
    </Modal>
...
const styles = StyleSheet.create({
  ...
  drawer: { position: 'absolute', top: 0, left: 0, bottom: 0, width: 280 },
  ...
  toolItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 10, borderRadius: 12, gap: 12 },
  toolIcon: { width: 40, height: 40, borderRadius: 12, justifyContent: 'center', alignItems: 'center' },
  toolLabel: { fontSize: 13, fontWeight: '500' },
  homeBtn: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 10, borderRadius: 12, gap: 12 },
