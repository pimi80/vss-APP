...
export default function WebViewScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <LeftDrawer isOpen={leftDrawerOpen} onClose={() => setLeftDrawerOpen(false)} onRefresh={handleRefresh} onBack={handleBack} onForward={handleForward} onGoHome={handleNavigate} canGoBack={canGoBack} canGoForward={canGoForward} />
      <RightDrawer isOpen={rightDrawerOpen} onClose={() => setRightDrawerOpen(false)} onNavigate={handleNavigate} onRefresh={handleRefresh} onBack={handleBack} onForward={handleForward} canGoBack={canGoBack} canGoForward={canGoForward} />
    </View>
  );
}
